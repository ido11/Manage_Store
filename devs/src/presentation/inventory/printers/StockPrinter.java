...
public class StockPrinter extends InventoryPrinter implements Printer {
    ...
    public int printMenu()
    {
        ...
        while (!valid) {
            ...
            System.out.println(ansi().bold().render(
                            ...
                            "@|yellow 1|@ - Remove products from stock\n" +
                            "@|yellow 2|@ - Move product stock location\n" +
                            "@|yellow 3|@ - Display specific product stock\n" +
                            "@|yellow 4|@ - Display all products in stock\n" +
                            "@|yellow 5|@ - Display products by category\n" +
