...
public class ProductsPrinter extends InventoryPrinter implements Printer {
    ...
    public String[] addProductDetailsPrompt() {
        ...
        try {
            ...
            System.out.print(ansi().render("@|yellow Enter product weight: |@\n"));
            curr_param = "Weight";
