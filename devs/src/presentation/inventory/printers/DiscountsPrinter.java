...
public class DiscountsPrinter extends InventoryPrinter implements Printer {
        ...
        while (!valid) {
            System.out.println(ansi().bold().render(
                    "@|green == Discounts management menu ==|@\n" +
                            ...
                            "@|yellow 5|@ - Display all Supplier discounts\n" +
                            "@|yellow 6|@ - Display discounted categories.\n" +
