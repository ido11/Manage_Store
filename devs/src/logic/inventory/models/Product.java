package logic.inventory.models;
...
public class Product {
    ...
    public Product(int barcode, String name, String manufacturer, double cost_price, double selling_price, double orig_selling_price, double orig_cost_price, int minimal_amount, double weight) {
    ...
    public Product(int barcode, double weight) {
        this.barcode = barcode;
        this.weight = weight;
    }
